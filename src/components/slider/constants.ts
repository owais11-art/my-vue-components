...
export const slideDirections: Map<string, string> = new Map([
    ['horizontal-default', 'ltr'],
    ['horizontal-reverse', 'rtl'],
    ['vertical-default', 'btt'],
    ['vertical-reverse', 'ttb']
])

export const TOTAL_SLIDER_PERCENTAGE: number = 100

export const HEX_SHORT_HAND_LENGTH = 4
export const HEX_LONG_HAND_LENGTH = 7
export const HEX_LENGTH_WITH_OPACITY = 9

export const EMPTY_STRING = ""

export const DEFAULT_OPACITY = 50

export const CURSORS: ICursors = {
    auto: 'auto',
    crosshair: 'crosshair',
    cursor: 'cursor',
    default: 'default',
    ...
    scrollbar: 'scrollbar',
    none: 'none',
    url: 'url(<url>)', // You can replace <url> with an actual URL
    inherit: 'inherit',
    initial: 'initial',
    revert: 'revert',
    unset: 'unset'
